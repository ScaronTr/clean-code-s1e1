...
var incompleteTaskHolder=document.getElementById("list-todo-tasks");//ul of #incompleteTasks
var completedTasksHolder=document.getElementById("list-completed-tasks");//completed-tasks
...
var createNewTaskElement=function(taskString){
    ...
    label.className='list-item__task-name';

    //Each elements, needs appending
    checkBox.type="checkbox";
    editInput.type="text";
    editInput.className="list-item__task";
